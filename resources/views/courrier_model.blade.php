                    ...
                    <div class="relative overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                        <div class="px-4 sm:px-6 lg:px-8 max-w-7xl  mx-auto sm:px-6 lg:px-8 nop">
                            <div class="sm:flex sm:items-center">
                                ...
                                <p class="mt-2 text-sm text-gray-700">liste de tous les models.</p>
                                </div>
                                <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                                    <a href="save_new_model" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Nouveau model</a>
                                </div>
                            </div>
                            <div class="mt-8 flex flex-col">
                                <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                    ...
                                    <table class="min-w-full table-fixed divide-y divide-gray-300">
                                        ...
                                        @foreach($model_arr as $td)
                                            <tr>
                                                ...
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{$td->content}}</td>
