                ...
                <div class="bg-primary overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-primary mx-auto text-white border-b border-gray-200">
                        <div class="text-center">
                            <h4>Enregistrer un nouveau collaborateur</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    <form class="space-y-6" action="save_new_collaborateur">
                        <div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="telephone" name="telephone" type="tel"  required class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                            </div>
                        </div>
