            ...
            <table class="min-w-full table-fixed divide-y divide-gray-300">
                ...
                @foreach($courrier_arr as $td)
                    <tr>
                        ...
                        <td> <a href="delete_courrier/{{$td->id}}" class="text-indigo-600 hover:text-indigo-900">Delete</a> | <a href="edit_courrier/{{$td->id}}" class="text-indigo-600 hover:text-indigo-900">Edit</a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
