<x-app-layout>
    ...
    <div class="max-w-7xl nop">
        <div class="sm:flex">
            <div class="mt-4 sm:mt-0 sm:ml-16">
                <form action="{{ route('partner.search')}}">
    ...
    <div class="sm:flex sm:items-center">
        ...
        <h1 class="text-xl font-semibold text-gray-900">Collaborateurs</h1>
        <p class="mt-2 text-sm text-gray-700">liste de tous les collaborateurs.</p>
        </div>
        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
            <a href="EnregistrerCollaborateur" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Nouveau collaborateur</a>
        </div>
    </div>
    <div class="mt-8 flex flex-col">
        ...
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
            ...
            <table class="min-w-full table-fixed divide-y divide-gray-300">
                ...
                <!-- Selected: "bg-gray-50" -->
                @foreach($collaborateur_arr as $td)
                    <tr>
                        ...
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{$td->telephone}}</td>
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{$td->status}}</td>
                        <td class="whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                        <td> <a href="delete_partner/{{$td->id}}" class="text-indigo-600 hover:text-indigo-900">Delete</a> | <a href="edit_partner/{{$td->id}}" class="text-indigo-600 hover:text-indigo-900">Edit</a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
