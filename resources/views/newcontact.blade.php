    ...
    <x-slot name="header">
        ...
        <ol role="list" class="flex items-center space-x-4">
            ...
            <div class="flex items-center">
                ...
                <a href="#" class="ml-4 text-sm font-medium text-gray-900 hover:text-gray-700">Gestion des contacts</a>
            </div>
            </li>
                ...
                <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    <form class="space-y-6" action="save_new_contact">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="adresse" name="adresse" type="text"  required class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                            </div>
                        </div>
